...
const { createProductController, updateProductController, getAllProductController, deleteProductController, getProductController } = require("../controller/product.controller");
...
router.post("/update-product/:product_id",sellerMiddleWare,deleteProductController);
router.post("/get-products/:product_id",authMiddleWare,getProductController);
